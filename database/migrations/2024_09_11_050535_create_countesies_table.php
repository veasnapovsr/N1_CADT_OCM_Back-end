...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('countesies', function (Blueprint $table) {
            $table->increments('id');
            $table->text('name')->comment('Name of countesy');
            $table->text('desp')->nullable()->comment('description of countesy');
            $table->string('tpid', 191)->nullable()->comment('The id of the parent which identify the whole type of them.');
            $table->integer('pid')->nullable()->comment('Parent id of this countesy');
    ...
    {
        Schema::dropIfExists('countesies');
    }
};
