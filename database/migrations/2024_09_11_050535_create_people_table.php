...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('people', function (Blueprint $table) {
            ...
            $table->integer('body_condition')->default(0);
            $table->text('body_condition_desp')->default(0);
            $table->timestamps();
            $table->softDeletes();
            ...
            $table->string('father_nid',191)->nullable(false);
            ...
            $table->integer('father_death')->default(0);
            ...
            $table->string('mother_nid',191)->nullable(false);
            ...
            $table->integer('mother_death')->default(0);
