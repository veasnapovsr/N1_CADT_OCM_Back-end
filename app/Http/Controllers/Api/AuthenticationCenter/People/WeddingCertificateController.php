...
class WeddingCertificateController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $crud->setRelationshipFunctions([
            ...
            'spouse' => [ 'id' , 'lastname' , 'firstname' , 'enfirstname' , 'enlastname' ] ,
    ...
    public function create(Request $request){
        ...
        $record = RecordModel::create([
            ...
            'pdf' => '' ,
            // spouse
            'spouse_id' => $request->spouse_id?? 0 ,
            'spouse_firstname' => $request->spouse_firstname?? '' ,
            'spouse_lastname' => $request->spouse_lastname?? '' ,
            'spouse_enfirstname' => $request->spouse_enfirstname?? '' ,
            'spouse_enlastname' => $request->spouse_enlastname?? '' ,
            'spouse_nid' => $request->spouse_nid?? '' ,
            'spouse_passport' => $request->spouse_passport?? '' ,
            'spouse_profession' => $request->spouse_profession?? '' ,
            'spouse_profession_organization' => $request->spouse_profession_organization?? '' ,
            'spouse_dob' => strlen( $request->spouse_dob ) ? \Carbon\Carbon::parse( $request->spouse_dob )->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') ,
            'spouse_nationality' => $request->spouse_nationality?? 'ខ្មែរ' ,
            'spouse_national' => $request->spouse_national?? 'ខ្មែរ' ,
            'spouse_pob' => $request->spouse_pob?? '' ,
            'spouse_address' => $request->spouse_address?? '' ,
            'spouse_death' => intval( $request->spouse_death ) > 0 ? 1 : 0 ,
            // spouse father
            'spouse_father_firstname' => $request->spouse_father_firstname?? '' ,
            'spouse_father_lastname' => $request->spouse_father_lastname?? '' ,
            'spouse_father_enfirstname' => $request->spouse_father_enfirstname?? '' ,
            'spouse_father_enlastname' => $request->spouse_father_enlastname?? '' ,
            'spouse_father_dob' => strlen( $request->spouse_father_dob ) ? \Carbon\Carbon::parse( $request->spouse_father_dob )->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') ,
            'spouse_father_nationality' => $request->spouse_father_nationality?? 'ខ្មែរ' ,
            'spouse_father_pob' => $request->spouse_father_pob?? '' ,
            'spouse_father_death' => intval( $request->spouse_father_death ) > 0 ? 1 : 0 ,
            // spouse mother
            'spouse_mother_firstname' => $request->spouse_mother_firstname?? '' ,
            'spouse_mother_lastname' => $request->spouse_mother_lastname?? '' ,
            'spouse_mother_enfirstname' => $request->spouse_mother_enfirstname?? '' ,
            'spouse_mother_enlastname' => $request->spouse_mother_enlastname?? '' ,
            'spouse_mother_dob' => strlen( $request->spouse_mother_dob ) ? \Carbon\Carbon::parse( $request->spouse_mother_dob )->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') ,
            'spouse_mother_nationality' => $request->spouse_mother_nationality?? 'ខ្មែរ' ,
            'spouse_mother_pob' => $request->spouse_mother_pob?? '' ,
            'spouse_mother_death' => intval( $request->spouse_mother_death ) > 0 ? 1 : 0 ,
    ...
    public function update(Request $request){
        if( isset( $request->id ) && $request->id > 0 && ( $record = RecordModel::find($request->id) ) !== null ){
            ...
            if( $record->update([
                ...
                'spouse_pob' => $request->spouse_pob?? '' ,
                'spouse_address' => $request->spouse_address?? '' ,
                'spouse_death' => $request->spouse_death?? 0 ,
                // Husband father
                'spouse_father_firstname' => $request->spouse_father_firstname?? '' ,
                'spouse_father_lastname' => $request->spouse_father_lastname?? '' ,
                'spouse_father_enfirstname' => $request->spouse_father_enfirstname?? '' ,
                ...
                'spouse_father_nationality' => $request->spouse_father_nationality?? 'ខ្មែរ' ,
                'spouse_father_pob' => $request->spouse_father_pob?? '' ,
                'spouse_father_death' => $request->spouse_father_death?? 0 ,
                // Husband mother
                'spouse_mother_firstname' => $request->spouse_mother_firstname?? '' ,
                'spouse_mother_lastname' => $request->spouse_mother_lastname?? '' ,
                'spouse_mother_enfirstname' => $request->spouse_mother_enfirstname?? '' ,
                ...
                'spouse_mother_nationality' => $request->spouse_mother_nationality?? 'ខ្មែរ' ,
                'spouse_mother_pob' => $request->spouse_mother_pob?? '' ,
                'spouse_mother_death' => $request->spouse_mother_death?? 0 ,
