...
use App\Models\People\NationalityCard as RecordModel;
...
class NicCertificateController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $builder->whereHas('people',function($query) use($request){
            $query->where('id',$request->people_id);
        });
    ...
    public function create(Request $request){
        ...
        $record = RecordModel::create([
            ...
            'start' => strlen( $request->start ) ? \Carbon\Carbon::parse( $request->start )->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') ,
            'end' => strlen( $request->end ) ? \Carbon\Carbon::parse( $request->end )->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') ,
            'desp' => $request->desp?? '' ,
            'pdf' => '' ,
            'distinguishing_mark' => $request->distinguishing_mark?? '' ,
