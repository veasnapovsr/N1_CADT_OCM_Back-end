...
use App\Models\People\Archeivement as RecordModel;
...
class ArcheivementController extends Controller
{
    ...
    public function create(Request $request){
        ...
        $record = RecordModel::create([
            ...
            'desp' => $request->desp ,
            'date' => strlen( $request->date ) ? \Carbon\Carbon::parse( $request->date )->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') ,
            'pdf' => '' ,
