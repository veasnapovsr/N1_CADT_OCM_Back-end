...
use App\Models\People\Passport as RecordModel;
...
class PassportCertificateController extends Controller
{
    ...
    public function create(Request $request){
        ...
        $record = RecordModel::create([
            'effective_date' => strlen( $request->effective_date ) ? \Carbon\Carbon::parse( $request->effective_date )->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') ,
            'expired_date' => strlen( $request->expired_date ) ? \Carbon\Carbon::parse( $request->expired_date )->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') ,
