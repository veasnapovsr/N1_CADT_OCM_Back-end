...
class OrganizationStructureController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $crud = new CrudController(new RecordModel(), $request, $this->fields , false , $this->renameFields , [
            'position' => function( $organizationStructure ){
                $structurePosition = $organizatoinStructure->structurePositions ;
                if( $officerJobs != null && $officerJobs->count() > 0 ){
