...
class KuntyController extends Controller
{
    ...
    public function update(Request $request)
    {
        if (($user = $request->user()) !== null) {
            ...
            $crud = new CrudController(new RecordModel(), $request, ['id', 'number', 'title', 'book_id',  'kunty_id', 'kunty', 'matika_id', 'matika', 'chapter_id', 'chapter', 'part_id', 'part', 'section_id', 'section', 'created_by', 'author', 'updated_by', 'editor']);
