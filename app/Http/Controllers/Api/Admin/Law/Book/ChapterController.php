...
class ChapterController extends Controller
{
    ...
    public function store(Request $request){
        if( ($user = $request->user() ) !== null ){
            ...
            $request->merge($input);
            $crud = new CrudController(new RecordModel(), $request, ['id', 'number', 'title', 'kunty_id', 'book_id', 'matika_id' , 'created_by', 'updated_by']);
    ...
    public function update(Request $request)
    {
        if (($user = $request->user()) !== null) {
            ...
            $crud = new CrudController(new RecordModel(), $request, ['id', 'number', 'title', 'book_id',  'kunty_id', 'kunty', 'matika_id', 'matika', 'part_id', 'part', 'section_id', 'section', 'created_by', 'author', 'updated_by', 'editor']);
